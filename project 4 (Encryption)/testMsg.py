...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        message_text = 'crazy party animal anmle' #'#9!   abcdefghijklmnopqrstuvwxyz   ABCDEFGHIJKLMNOPQRSTUVYWXYZ'
        
        cipher = Message.build_shift_dict(self, shift)  #bring in cipher from build_shift_dict()
                
        for i in message_text:  #check each character in message
...
#---- Message Class TEST ----
print(Message.apply_shift('crazy party animal anmle', 24))
